...
namespace promodel.servicios
{
    public class PersonasCouchDbContext : CouchContext
    {
        ...
        protected override void OnDatabaseCreating(CouchDatabaseBuilder databaseBuilder)
        {
            ...
            databaseBuilder.Document<Persona>()
                .HasIndex(IDX_PERSONA_X_NOMBREARTISTICO, b => b.IndexBy(b => b.NombreArtistico));
            databaseBuilder.Document<Persona>()
               .HasIndex(IDX_PERSONA_X_EDAD, b => b.IndexBy(b => b.Edad));
            databaseBuilder.Document<Persona>()
               .HasIndex(IDX_PERSONA_X_NOMBRE, b => b.IndexBy(b => b.Nombre));
