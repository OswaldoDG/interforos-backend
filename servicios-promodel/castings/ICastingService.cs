...
public interface ICastingService
{
    ...
    Task<Respuesta> InscripcionCasting(string ClienteId, Persona Persona, string CastingId, string CategoriaId, bool Abandonar, string UsuarioId);
    Task<RespuestaPayload<List<string>>> CategoriasModeloCasting(string ClienteId, string CastingId, Persona Persona, string UsuarioId);
}
