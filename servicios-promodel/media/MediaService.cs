...
public class MediaService: IMedia
{
    ...
    public MediaService(MediaCouchDbContext db, IDistributedCache cache, IConfiguration configuration, IAlmacenamiento almacenamiento)
    {
        this.db = db;
        this.cache = cache;
    ...
    public async Task<bool> EliminarElemento(string ClienteId ,string UsuarioId, string ElementoId)
    {
        ...
        if (m != null)
        {
            ...
            if (e != null)
            {
                ...
                await almacenamiento.DeleteFile(ClienteId,e.Id);             
            }
